...
export const SiteFooter: React.FC<{ onTabChange?: (tab: TabType) => void }> = ({ onTabChange }) => {
  return (
    <footer className="py-12 bg-paper text-ink border-t border-line font-sans">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-grey-7">
